    ...
    const data = {
        ...
        datasets: [
          {
            ...
            data: [48, 48, 60, 39, 56, 37, 30], // Dữ liệu cho biểu đồ
            fill: true,
          },
          {
            ...
            pointBorderColor: '#fff',
            data: [65, 59, 40, 51, 36, 25, 40], // Dữ liệu cho biểu đồ thứ hai
            fill: true,
          },
        ],
      };
      ...
      const options = {
        ...
        scales: {
          x: {
            ticks: {
              color: "#000", // Màu sắc trục X
            },
          },
          y: {
            ticks: {
              color: "#000", // Màu sắc trục Y
            },
          },
        },
      };
      ...
      const data1 = {
        ...
        datasets: [
          {
            label: 'Monthly Income', // Tiêu đề biểu đồ
            backgroundColor: 'rgba(26,179,148,0.5)', // Màu nền
            borderColor: 'rgba(26,179,148,1)', // Màu đường viền
            data: [48, 50, 60, 39, 56, 37, 30], // Dữ liệu cho biểu đồ
            fill: true, // Bật tính năng fill để tạo biểu đồ diện tích
          }
        ]
      };
        ...
        <div className="row">
            ...
            <div className="col-lg-4">
                <div className="ibox float-e-margins">
                    <div className="ibox-title">
                        <span className="label label-info pull-right">Annual</span>
                        <h5>Revenues (month)</h5>
                    </div>
                    <div className="ibox-content">
                        <h1 className="no-margins">70,800$</h1>
                        <div className="stat-percent font-bold text-info">20% <i className="fa fa-level-up"></i></div>
                        <small>New orders</small>
                    </div>
                </div>
